	...
	<%--	<ul class="navbar-nav ${gradientCss } sidebar sidebar-dark accordion " id="accordionSidebar">
			...
			<li class="nav-item">
				<c:if test="${fn:contains(USER_ROLE,'ROLE_EMPLOYEE')}">
					...
					<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseSite2" aria-expanded="true" aria-controls="collapseSite2">
						<i class="fas fa-fw fa-cog"></i>
						<span>사이트관리</span>
					</a>
					<div id="collapseSite2" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
						<div class="bg-white py-2 collapse-inner rounded">
							...
							<a class="collapse-item" href="<c:out value="${bannerManageUrl }"/>" data-menu-id="bannerManage">메인배너 관리</a>
							<c:url var="popupManageUrl" value="/decms/popup/popupManage.do">
								<c:param name="menuId" value="popupManage"/>
							</c:url>
							<a class="collapse-item" href="<c:out value="${popupManageUrl}"/>" data-menu-id="popupManage">팝업 관리</a>
							<c:url var="themeManageUrl" value="/decms/thema/themaManage.do">
								<c:param name="menuId" value="themeManage"/>
							</c:url>
							<a class="collapse-item" href="${themeManageUrl}" data-menu-id="themeManage">테마 관리</a>
							<c:url var="bestManageUrl" value="/decms/best/bestManage.do">
								<c:param name="menuId" value="bestManage"/>
							</c:url>
							<a class="collapse-item" href="${bestManageUrl}" data-menu-id="bestManage">베스트 관리</a>
							<c:url var="saleManageUrl" value="/decms/sale/saleManage.do">
								<c:param name="menuId" value="saleManage"/>
							</c:url>
							<a class="collapse-item" href="${saleManageUrl}" data-menu-id="saleManage">특가 관리</a>
						</div>
						<div class="bg-white py-2 collapse-inner rounded">
							<h6 class="collapse-header">통합관리</h6>
							...
							<a class="collapse-item" href="<c:out value="${brandManageUrl }"/>" data-menu-id="brandManage">브랜드관 관리</a>
							<a class="collapse-item" href="#" data-menu-id="">기획전/테마관 관리</a>
							<c:url var="eventManageUrl" value="/decms/event/eventManage.do">
								<c:param name="menuId" value="eventManage"/>
							</c:url>
							<a class="collapse-item" href="${eventManageUrl}" data-menu-id="eventManage">이벤트 관리</a>
							<a class="collapse-item" href="#" data-menu-id="">쿠폰 관리</a>
							<a class="collapse-item" href="#" data-menu-id="">공동구매 관리</a>
							<a class="collapse-item" href="#" data-menu-id="">모두LIVE 관리</a>
						</div>
					</div>
					...
					<div id="collapseCP" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
						<div class="bg-white py-2 collapse-inner rounded">
							...
							<a class="collapse-item" href="<c:out value="${cmpnyManageUrl }"/>" data-menu-id="cmpnyManage">업체등록</a> &lt;%&ndash;2020.10.07 오영석 차장 수정요청으로 업체관리에서 업체등록으로 명칭변경 &ndash;%&gt;
						</div>
					</div>
				</c:if>
				...
				<c:if test="${fn:contains(USER_ROLE,'ROLE_EMPLOYEE')}"> &lt;%&ndash; 개발까지 임시로 CP 닫음 &ndash;%&gt;
...
&lt;%&ndash; 									<c:param name="bbsId" value="BBSMSTR_0000000000CP"/> &ndash;%&gt;
								</c:url>
...
&lt;%&ndash; 								<c:url var="eventManageUrl" value="/decms/event/eventManage.do"> &ndash;%&gt;
&lt;%&ndash; 									<c:param name="menuId" value="eventManage"/> &ndash;%&gt;
&lt;%&ndash; 								</c:url> &ndash;%&gt;
&lt;%&ndash; 								<a class="collapse-item" href="${eventManageUrl}" data-menu-id="eventManage">이벤트관리</a> &ndash;%&gt;
							</div>
							<div class="bg-white py-2 collapse-inner rounded">
...
&lt;%&ndash; 							<c:url var="alimtalkUrl" value="/decms/alimtalk/alimtalkManage.do"> &ndash;%&gt;
&lt;%&ndash; 								<c:param name="menuId" value="alimtalkMaster"/> &ndash;%&gt;
&lt;%&ndash; 							</c:url> &ndash;%&gt;
&lt;%&ndash; 							<a class="collapse-item" href="<c:out value="${alimtalkUrl }"/>" data-menu-id="alimtalkMaster">알림톡 발송내역</a> &ndash;%&gt;
<!-- 						</div> -->
